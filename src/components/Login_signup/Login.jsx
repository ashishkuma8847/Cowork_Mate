...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // You can store token, show toast, redirect, etc.
        } catch (error) {
                ...
                <div className="flex md:gap-8 gap-[20px] lg:flex-row flex-col-reverse  items-center lg:items-start font-inter pt-[30px] md:pt-[54px]">
                    <div className="flex flex-col  max-w-[644px] w-full ">
                        <div className="flex flex-col gap-[22px] md:pb-[40px] pb-[30px]">
                            <Link to={"/"} className="cursor-pointer lg:block hidden">
                                <img src="/svg/arrow-left.svg" className="w-6 h-6" alt="arrow-left" />
                            </Link>
                            <h1 className="md:text-[40px] text-[20px] leading-[130%] font-semibold">Log in</h1>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col">
                            ...
                            <div className="flex flex-col md:gap-[14px] gap-[10px] md:pb-[30px] pb-[14px]">
                                <label className="md:text-[20px] text-xs  leading-[130%] font-medium" htmlFor="input1">E-mail</label>
                                <input
                                    type="email"
                                    id="input1"
                            ...
                            <div className="flex flex-col text-black md:gap-[14px] gap-[10px] md:pb-[22px] pb-[14px]">
                                <label htmlFor="input2" className="md:text-[20px] text-xs  leading-[130%] font-medium">Password</label>
                            ...
                            <div className="flex justify-between items-center md:pb-[31px] pb-[30px]">
                                <div onClick={() => setclick(!click)} className="flex cursor-pointer md:gap-3 gap-2  items-center">
                                    ...
                                    <h4 className="md:text-[16px] text-[10px]">Remember me</h4>
                                </div>
                                <Link to={"/forgetpassword"}>
                                <h4 className="text-violet md:text-base text-[10px] leading-[100%]">Forgot Password?</h4>
                                </Link>
                            </div>

                            {/* Login Button */}
                            <div className="flex flex-col justify-center items-center md:gap-5 gap-[20px] pb-[30px]
                             ">
                                ...
                                <h4 className="md:text-[16px] text-[14px]">Don't have an Account? <Link to={"/signup"} className="text-violet">Create account</Link></h4>
                            </div>
                        </form>
                        {/* FORM END */}
